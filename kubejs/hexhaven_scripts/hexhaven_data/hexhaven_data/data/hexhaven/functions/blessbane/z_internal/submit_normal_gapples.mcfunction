execute store success score ok hexhaven.blessbane.z_internal store result score gapples_submitted hexhaven.blessbane.z_internal run clear @s golden_apple
