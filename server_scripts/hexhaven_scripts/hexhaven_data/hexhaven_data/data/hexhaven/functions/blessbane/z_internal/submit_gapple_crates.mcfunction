execute store success score ok hexhaven.blessbane.z_internal store result score gapples_submitted hexhaven.blessbane.z_internal run clear @s quark:golden_apple_crate

execute if score ok hexhaven.blessbane.z_internal matches 1 run scoreboard players operation gapples_submitted hexhaven.blessbane.z_internal *= gapples_per_crate hexhaven.blessbane.z_internal
